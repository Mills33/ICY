...
kable(chosentable,row.names = F, format="latex",longtable = T, caption = "individuals recommended for reintroduction/translocation.", booktabs=TRUE)%>%kable_styling(latex_options = c("striped","HOLD_position","repeat_header"))%>% row_spec(0, bold = T)
...
kable(All_data, align="c", format ="latex", longtable =T, caption = "Information about individuals (both sexes) most to least suitable for translocation", booktabs=TRUE)%>%kable_styling(latex_options = c("striped","HOLD_position","repeat_header"), font_size = 7, full_width = T) %>% 
  row_spec(0, bold = T) %>% 
